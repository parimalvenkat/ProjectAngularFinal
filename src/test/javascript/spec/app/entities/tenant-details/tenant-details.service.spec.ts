...
describe('Service Tests', () => {
    ...
    describe('TenantDetails Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TenantDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/tenant-details/' + 123);
            });
            it('should return TenantDetails', () => {

                let entity: TenantDetails;
                service.find(123).subscribe((_entity: TenantDetails) => {
                    entity = _entity;
                });
