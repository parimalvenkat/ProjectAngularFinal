...
describe('Service Tests', () => {
    ...
    describe('TenantContactDetails Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TenantContactDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/tenant-contact-details/' + 123);
            });
            it('should return TenantContactDetails', () => {

                let entity: TenantContactDetails;
                service.find(123).subscribe((_entity: TenantContactDetails) => {
                    entity = _entity;
                });
