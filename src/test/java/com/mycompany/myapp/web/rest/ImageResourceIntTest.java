...
public class ImageResourceIntTest {
    ...
    private static final String DEFAULT_CONTAINER_IMAGE = "AAAAAAAAAA";
    private static final String UPDATED_CONTAINER_IMAGE = "BBBBBBBBBB";
    ...
    public void createImage() throws Exception {
        ...
        assertThat(testImage.getContainerImage()).isEqualTo(DEFAULT_CONTAINER_IMAGE);
    }
    ...
    public void getAllImages() throws Exception {
        ...
        restImageMockMvc.perform(get("/api/images?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].containerImage").value(hasItem(DEFAULT_CONTAINER_IMAGE.toString())));
    }
    ...
    public void getImage() throws Exception {
        ...
        restImageMockMvc.perform(get("/api/images/{id}", image.getId()))
            ...
            .andExpect(jsonPath("$.containerImage").value(DEFAULT_CONTAINER_IMAGE.toString()));
    }
    ...
    public void updateImage() throws Exception {
        ...
        updatedImage
            ...
            .containerImage(UPDATED_CONTAINER_IMAGE);
        ...
        assertThat(testImage.getContainerImage()).isEqualTo(UPDATED_CONTAINER_IMAGE);
    }
