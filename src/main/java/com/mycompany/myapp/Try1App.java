...
public class Try1App {

    private static final Logger log = LoggerFactory.getLogger(Try1App.class);

    private final Environment env;

    public Try1App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Try1App.class);
