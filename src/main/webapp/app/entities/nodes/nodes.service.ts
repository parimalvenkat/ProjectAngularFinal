...
export class NodesService {
    ...
    create(nodes: Nodes): Observable<Nodes> {
    ...
    update(nodes: Nodes): Observable<Nodes> {
        const copy = this.convert(nodes);
    ...
    find(id: number): Observable<Nodes> {
     ...
     */
    private convertItemFromServer(json: any): Nodes {
        const entity: Nodes = Object.assign(new Nodes(), json);
        return entity;
    }
